                ...
                <div class="card-body p-5">
                    ...
                    <form action="index.php?url=admin/store-product" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="product_name" id="pname" placeholder="Name" required>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="form-floating flex-grow-1">
                                <input type="number" step="0.01" class="form-control border-start-0" name="price" id="price" placeholder="0.00" required>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <input type="file" class="form-control shadow-none" id="product_img" name="product_img" accept="image/*" required>
                            </div>
                            <div class="form-text">Recommended size: 400x400px (JPG/PNG).</div>
                        </div>

                        <div class="d-grid gap-2">
                            <button type="submit" name="submit" class="btn btn-primary py-2 fw-bold rounded-3 shadow-sm">
                                Save Product
                            </button>
                            <a href="index.php?url=admin/products" class="btn btn-link btn-sm text-decoration-none text-muted">
                                Cancel & Go Back
                            </a>
                        </div>
